...
- The active-assets table and the archived-assets table have a Tags column after Name. It shows up to two labels and a `+N` count; open the searchable picker to see all tags. Adding or removing a tag here saves immediately. Controls wait for the saved result before showing the change.
