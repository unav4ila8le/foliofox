  ...
  public: {
    Tables: {
      ...
      position_tag_assignments: {
        ...
        Relationships: [
          {
            foreignKeyName: "position_tag_assignments_position_id_fkey"
            columns: ["position_id"]
            isOneToOne: false
            referencedRelation: "positions"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "position_tag_assignments_tag_id_fkey"
            columns: ["tag_id"]
            isOneToOne: false
            referencedRelation: "user_position_tags"
            referencedColumns: ["id"]
          },
        ]
      }
